    ...
    <footer className="px-4 md:px-8 pb-6">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 4px 30px rgba(0, 0, 0, 0.06), 0 1px 4px rgba(184, 148, 62, 0.08)',
        }}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div>
              ...
              <address
                ...
                style={{ fontFamily: 'var(--font-body)' }}
              >
                <p className="text-[var(--color-text-secondary)] font-medium">{SHUL_NAME}</p>
                ...
                <p>
                  <span className="text-xs text-[var(--color-gold)] uppercase tracking-wider mr-1">WhatsApp:</span>
                  <a
                    href={`https://wa.me/${SHUL_PHONE.replace(/[^\d+]/g, '')}`}
                    target="_blank"
        ...
        {/* Copyright Bar */}
        <div
          className="px-8 md:px-12 py-5 flex items-center justify-center"
          style={{
